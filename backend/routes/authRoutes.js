...
const { signin, signup, signout, isSignedIn } = require("../controllers/authControls");
...
router.post(
    ...
    [
        ...
        check("vision", "vision must be 15+ chars long").isLength({ min: 15 }),
        check("mission", "mission must be 15+ chars long").isLength({ min: 15 }),
